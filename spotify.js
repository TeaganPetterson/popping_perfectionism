var redirect_uri = "http://127.0.0.1:3000/podcast";

var client_id = process.env.SPOTIFY_CLIENT_ID;
var client_secret = process.env.SPOTIFY_CLIENT_SECRET; // In a real app you should not expose your client_secret to the user
